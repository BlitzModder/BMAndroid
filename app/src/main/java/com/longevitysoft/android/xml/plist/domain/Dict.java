...
public class Dict extends PListObject {
	...
	protected LinkedHashMap<java.lang.String, PListObject> configMap;

	public Dict() {
		configMap = new LinkedHashMap<java.lang.String, PListObject>();
	 ...
	 */
	public LinkedHashMap<java.lang.String, PListObject> getConfigMap() {
		return configMap;
	}
	 ...
	 */
	public void setConfigMap(LinkedHashMap<java.lang.String, PListObject> configMap) {
	...
	public <E extends PListObject> E getConfigurationObject(java.lang.String key) {
		...
		if (st.hasMoreTokens()) {
			LinkedHashMap<java.lang.String, PListObject> dict = configMap;
			Object obj;
